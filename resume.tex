...
\positionedbox{left}{0.7\textwidth}{%
	...
	\information{\url{http://dsnyder.github.com}}{pic}{\Writinghand}\\%
}
...
% Personal Statement
I am an enthusiastic software developer seeking to collaborate with others. I am motivated to create software systems that are intuitive and exhibit elegance.
...
\item \cvcompany{CUBRC, Inc.}{Software Engineer}{2012 - Present}{http://www.cubrc.org/}\cvsublevel{%
	\cvsubbullet{Software Developer for IntellEx }%
	\cvsubbullet{On-site customer support in San Diego}%
...
\item \cvcompany{Space and Naval Warfare Systems Center, Pacific}{Computer Scientist}{2009 - 2012}{http://www.spawar.navy.mil/sandiego/}\cvsublevel{%
	\cvsubbullet{Software developer for the Open Track Management service and lead engineer for the Future Movement Service}%
	\cvsubbullet{Programmed in Java and worked with MySQL and Apache Cassandra}%
	\cvsubbullet{Clearance: Secret}%
	}
\end{itemize}
...
Loves sailing, coffee and video games. I hail from the city of garbage plates.
